...
const buildCashOutPDF = (data, dataCallback, endCallback) => {
    ...
    doc.text(`${data.amountValue} ${data.currency}`, // 200,00 PLN
    rightRowMargin, areaTwoStartHeight + 25, {
        width: 200,
        align: "right",
    });
    let rowCounter = 0;
    for (const row of data.denomination) {
        ...
        doc.text("=", denominationMargin + 135, denominationStartHeight + rowCounter * denominationRowSpacing, {
            width: 20,
            align: "left",
        });
