 ...
 */
const buildCashOutPDF = (data, dataCallback, endCallback) => {
    ...
    doc.text(data.transactionStartDateTime, // 12.11.2023 18:15:13
    rightRowMargin, areaOneStartHeight, {
        width: 200,
        align: "right",
    });
    // row 2
    ...
    doc.font(montserratMediumPath, 14);
    doc.text(data.deviceName, // RNET6338
    rightRowMargin, areaOneStartHeight + 25, {
        width: 200,
        align: "right",
    });
    // row 3
    ...
    doc.font(montserratMediumPath, 14);
    doc.text(data.transactionID, // 02C5C7223161I0004812
    rightRowMargin, areaOneStartHeight + 50, {
        width: 200,
        align: "right",
    });
    //row 4
    ...
    // lokalizacja - linia 1
    doc.font(montserratMediumPath, 14);
    doc.text(data.localizationName, // Biedronka
    rightRowMargin, areaOneStartHeight + 75, {
        width: 200,
        align: "right",
    });
    // lokalizacja - linia 2
    doc.text(data.localizationStreet, // Zwycięska 9-23
    rightRowMargin, areaOneStartHeight + 95, {
        width: 200,
        align: "right",
    });
    // lokalizacja - linia 3
    doc.text(data.localizationCity, // Wrocław
    rightRowMargin, areaOneStartHeight + 115, {
        width: 200,
        align: "right",
    });
    // ----------- KONIEC ROW Z INFO  ------------------------------ //
    ...
    doc.text("____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________", leftRowMargin, areaTwoStartHeight - 30, {
        width: 505,
        align: "center",
    });
    // ------------------------------------------------------------- //
    ...
    doc.text(data.tempcardNumberFormatted, // 40 56** **** ** *532
    rightRowMargin, areaTwoStartHeight, {
        width: 200,
        align: "right",
    });
    // KWOTA WYPŁATY
    ...
    doc.text(`${data.amountValue},00 ${data.currency}`, // 200,00 PLN
    rightRowMargin - 197, areaTwoStartHeight + 25, {
        width: 400,
        align: "right",
    });
    ...
    // ---------------------------------------------------------------- //
    doc.font(montserratRegularPath, 4);
    doc.text("____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________", leftRowMargin, footerStartHeight + 20, {
        width: 505,
        align: "center",
    });
    // ---------------------------------------------------------------- //
